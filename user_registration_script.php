<?php
    ...
    if(!preg_match($regex_email,$email)){
        echo "Nieprawidłowy email. Przekierowane do rejestracji..."; 
        ?>
    ...
    if(strlen($password)<6){
        echo "Hasło powinno zawierać co najmniej 6 znaków. Przekierowanie do rejestracji...";
        ?>
        <meta http-equiv="refresh" content="2;url=signup.php" />
        <?php
    }
    ...
    if($rows_fetched>0){
        ?>
        <script>
            window.alert("Ten email już jest w użyciu!");
        </script>
